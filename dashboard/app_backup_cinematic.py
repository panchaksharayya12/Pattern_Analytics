...
/* Hide Streamlit technical chrome */
...
<div class="pattern-hero">
    ...
    <div class="hero-badge">
        Pattern Analytics ? Banking Intelligence
    </div>

    <h1>
        Customer Segmentation &<br>
        Churn Pattern Analytics
    </h1>

    <p>
        An interactive analytics platform for understanding customer
        churn patterns, segment behavior, geographic differences,
        engagement signals, and high-value customer exposure across
        European banking.
    </p>

    <div class="hero-meta">
        <div class="hero-pill">10,000 Customers</div>
        <div class="hero-pill">European Banking</div>
        <div class="hero-pill">Interactive Analytics</div>
        <div class="hero-pill">Business Intelligence</div>
    </div>
...
<div class="pattern-nav">
    ...
    <a href="#executive-insights">Insights</a>
