...
/* =====================================================
   INPUTS & WIDGETS (SELECTBOX, MULTISELECT, TEXT INPUT)
   ===================================================== */

/* Selectbox & Multiselect base containers */
...
# =========================================================
st.html('<div id="overview" class="section-anchor"></div>')
st.html("""
...
# =========================================================
st.html('<div id="landscape" class="section-anchor"></div>')
st.html("""
...
# =========================================================
st.html('<div id="patterns" class="section-anchor"></div>')
st.html("""
...
# =========================================================
st.html('<div id="financial-risk" class="section-anchor"></div>')
st.html("""
...
# =========================================================
st.html('<div id="customer-stories" class="section-anchor"></div>')
st.html("""
