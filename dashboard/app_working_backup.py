...
# Load cinematic hero image
hero_image_path = Path("assets/hero_europe_night.png")
...
<div class="cinematic-nav">
    ...
    <div class="nav-links">
        ...
        <a href="#geographic-churn-analysis">LANDSCAPE</a>
        <a href="#product-credit-score-analysis">CUSTOMER PATTERNS</a>
        <a href="#financial-geographic-deep-dive">FINANCIAL RISK</a>
        <a href="#customer-drill-down-high-value-explorer">CUSTOMER STORIES</a>
    </div>
...
# =========================================================
st.html("""<div id="executive-summary"></div>""")
...
st.html("""
<div class="cinematic-image-section"
style="background-image:url('https://images.unsplash.com/photo-1526772662000-3f88f10405ff?auto=format&fit=crop&w=2200&q=85');">

<div class="cinematic-image-content">

<div class="cinematic-number">01 · THE LANDSCAPE</div>

<div class="cinematic-image-title">A European customer landscape.</div>

<div class="cinematic-image-text">
Ten thousand customer records across France, Germany and Spain
reveal distinct patterns of observed customer churn across markets
...
""")
st.html("""<div id="geographic-churn-analysis"></div>""")

st.subheader("The Landscape · Geographic Churn")
...
<div class="dark-transition-kicker">02 · CUSTOMER PATTERNS</div>

<div class="dark-transition-title">
What patterns appear across the customer base?
</div>

</div>
""")
st.html("""<div id="product-credit-score-analysis"></div>""")

st.subheader("Customer Patterns · Behavioral Signals")
...
st.html("""<div id="financial-geographic-deep-dive"></div>""")

st.subheader("Financial Risk · Value at Risk")
...
st.html("""<div id="customer-drill-down-high-value-explorer"></div>""")

st.subheader("Customer Stories · Individual Explorer")
...
overall_filtered_churn = filtered_df["Exited"].mean() * 100
...
highest_age_group = age_analysis["Churn_Rate"].idxmax()
highest_age_rate = age_analysis["Churn_Rate"].max()

# Highest observed geography
highest_geo = geo_analysis["Churn_Rate"].idxmax()
highest_geo_rate = geo_analysis["Churn_Rate"].max()

# Activity comparison
if 1 in activity_analysis.index and 0 in activity_analysis.index:
    active_rate = activity_analysis.loc[1, "Churn_Rate"]
    inactive_rate = activity_analysis.loc[0, "Churn_Rate"]
else:
    active_rate = None
    inactive_rate = None
